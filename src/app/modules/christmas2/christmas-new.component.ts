...
@Component({
  selector: 'app-christmas-new',
  templateUrl: './christmas-new.component.html',
  styleUrls: ['./christmas-new.component.scss']
})
export class ChristmasNewComponent implements OnInit {
  interval: any;
  endTime!:Timer;
